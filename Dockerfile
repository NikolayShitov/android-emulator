...
RUN apt-get -y update \
    && apt-get -y install sudo qemu qemu-kvm libvirt-bin bridge-utils virt-manager cpu-checker libpulse0 software-properties-common bzip2 socat curl libguestfs-tools \
    && apt-get clean
